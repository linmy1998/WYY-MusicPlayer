  ...
  <div class="musiclyric">
    <el-drawer ref='drawer' :modal='false' direction="btt" :visible.sync="showLyric" :with-header="false">
      <div class="drawerBox">
        <div class="lyricbox">
          <div class="img_left">
            <img :src="songDetailObj.pic" alt="" class="pic">
            <div class="wrap">
              <span><img src="../../../assets/img/like-ali.svg" alt="">喜欢</span>
              <span><img src="../../../assets/img/collect-ali.svg" alt="">收藏</span>
              <span><img src="../../../assets/img/download-ali.svg" alt="">下载</span>
              <span><img src="../../../assets/img/share-ali .svg" alt="">分享</span>
            </div>
          </div>
...
import CommentList from '@/views/home/childComps/CommentList.vue'
